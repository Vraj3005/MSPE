...
class TradingSignal(Base):
    ...
    signal_type: Mapped[str] = mapped_column(String(16), nullable=False) # 'LONG', 'SHORT', 'EXIT', 'NO_TRADE'
    ...
    details: Mapped[dict] = mapped_column(JSON, nullable=False) # e.g. {"portfolio_risk_weight": 0.01, ...}
    ...
    __table_args__ = (
        Index("idx_trading_signals_lookup", "asset_id", "timestamp"),
    )
