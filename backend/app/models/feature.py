...
class MarketFeature(Base):
    ...
    resolution: Mapped[str] = mapped_column(String(8), primary_key=True, nullable=False) # '1d', '1h', '1m'
    ...
    macd_histogram: Mapped[Optional[float]] = mapped_column(Numeric(18, 6), nullable=True)
    ...
    historical_volatility_30: Mapped[Optional[float]] = mapped_column(Numeric(10, 6), nullable=True)
    parkinson_volatility_30: Mapped[Optional[float]] = mapped_column(Numeric(10, 6), nullable=True)

    # Market Structure Features
    support_30: Mapped[Optional[float]] = mapped_column(Numeric(18, 6), nullable=True)
    resistance_30: Mapped[Optional[float]] = mapped_column(Numeric(18, 6), nullable=True)
    volume_profile: Mapped[Optional[dict]] = mapped_column(JSON, nullable=True) # stores: [{"price_bin": float, "volume_weight": float}, ...]

    # Statistical Features
    returns_1d: Mapped[Optional[float]] = mapped_column(Numeric(10, 6), nullable=True) # return since last bar
    log_returns: Mapped[Optional[float]] = mapped_column(Numeric(10, 6), nullable=True)
    rolling_mean_30: Mapped[Optional[float]] = mapped_column(Numeric(18, 6), nullable=True)
    rolling_variance_30: Mapped[Optional[float]] = mapped_column(Numeric(18, 6), nullable=True)
    rolling_skewness_30: Mapped[Optional[float]] = mapped_column(Numeric(8, 4), nullable=True)
    rolling_kurtosis_30: Mapped[Optional[float]] = mapped_column(Numeric(8, 4), nullable=True)
