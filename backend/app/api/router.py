...
api_router.include_router(features.router, prefix="/features", tags=["Quantitative Features"])
api_router.include_router(forecasts.router, prefix="/forecasts", tags=["Forecasting Engine"])
api_router.include_router(projections.router, prefix="/projections", tags=["Surface Projections"])
